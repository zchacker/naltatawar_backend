...
<div class="mt-4 flex flex-col gap-8">
    ...
    <a href="{{ route('client.support.create') }}" class="bg-cta px-8 py-2 items-center rounded-full flex gap-2 self-start">
        ...
        <tbody>
            ...
            <tr class="odd:bg-white even:bg-gray-100  border-b border-gray-100">
                ...
                <td class="px-6 py-4 flex gap-4">
                    <a href="{{ route( 'client.support.update' , $item->id ) }}" class="text-blue-500 underline"> {{__('view')}} </a>                    
                </td>
            </tr>
            @endforeach
