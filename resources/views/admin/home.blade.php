...
<div class="grid lg:grid-cols-3 grid-cols-1  gap-4 items-center justify-center">
    ...
    <div class="flex flex-col gap-4 justify-center items-center bg-light-secondary p-6 rounded-lg ">
        <h2 class="font-bold text-xl"> إجمالي المسجلين </h2>
        <p>( {{ $subscribers_count }} )</p>
    </div>

    <div class="flex flex-col gap-4 justify-center items-center bg-light-secondary p-6 rounded-lg ">
        <h2 class="font-bold text-xl"> إجمالي المستخدمين </h2>
        <p>( {{ $users_count }} )</p>
    </div>

    <div class="flex flex-col gap-4 justify-center items-center bg-light-secondary p-6 rounded-lg ">
        <h2 class="font-bold text-xl"> اشتراكات نشطة </h2>
        <p>( {{ $active_subscriptions }} )</p>
    </div>

    <div class="flex flex-col gap-4 justify-center items-center bg-light-secondary p-6 rounded-lg ">
        <h2 class="font-bold text-xl"> اشتراكات غير نشطة </h2>
        <p>( {{ $inactive_subscriptions }} )</p>
    </div>

    <div class="flex flex-col gap-4 justify-center items-center bg-light-secondary p-6 rounded-lg ">
        <h2 class="font-bold text-xl"> طلبات اتصال </h2>
        <p>( {{ $contact_requests }} )</p>
    </div>
</div>
