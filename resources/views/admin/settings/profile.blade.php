...
<div class="mt-4 flex flex-col gap-8 w-full">
    ...
    <div class="md:w-1/2">
        ...
        <fieldset class="border border-gray-300 rounded-lg p-6 shadow-sm bg-white">
            ...
            <form action="{{ route('admin.settings.update.profile') }}" id="myform" method="post" class="w-full flex flex-col gap-4">
                @csrf
        ...
        <fieldset class="border border-gray-300 rounded-lg p-6 shadow-sm bg-white mt-16">
            ...
            <form action="{{ route('admin.settings.update.password') }}" id="myform" method="post" class="w-full flex flex-col gap-4">
                @csrf
